"""
turbo_moc.geometry.meridional -- meridional (axial-radial, x-r) view of a
stator + rotor stage, sharing its hub/tip radii inputs with the flared 3D
blade extrusion (see turbo_moc.geometry.blade.export_flared_blade_step).
...
def build_meridional_view(
    ...
    rotor_axial_chord]) -- for turbo_moc.plotly/mpl's plot_meridional_view.
