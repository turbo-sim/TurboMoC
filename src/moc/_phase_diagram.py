...
plotting. Shared by moc.plotting_mpl and moc.plotting_plotly so the fluid
...
moc.plotting_mpl draws directly with the cached Fluid's own
...
of hand-rolled dome lines. moc.plotting_plotly can't call into a
