...
data = design_rotor_vortex_blade(
    ...
    beta_inlet=20.0,  # beta_outlet is always derived from continuity now (Eq. 9
                      # generalized) -- not a free input, see notes/rotor_vortex_blade.md
    backend="HEOS",
    num_points=60,
)
...
ax2.fill(b["x"], b["y"] - data['pitch'], color="0.55", edgecolor="0.15", lw=1.5)
